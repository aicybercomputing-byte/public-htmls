...
<body>
  <div class="wrap">
    ...
    ${sections}
    <footer>
      Regenerated by <code>scripts/generate-index.js</code> on pull, checkout, and commit.
...
function generateIndex({ root = ROOT, output = OUTPUT, write = true } = {}) {
  ...
  return { pages, groups, html, output };
}

if (require.main === module) {
  const { pages, output } = generateIndex();
