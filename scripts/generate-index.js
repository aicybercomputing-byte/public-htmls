      ...
      <li class="page-item">
        <details>
          ...
          <div class="preview-wrap">
            <iframe class="page-preview" src="${href}" title="Preview of ${label}" loading="lazy"></iframe>
          </div>
        </details>
      </li>`;
}
...
<body>
  <div class="wrap">
    ...
    ${sections}
    <footer>
      Regenerated by <code>scripts/generate-index.js</code> when repo files change (except root <code>index.html</code>).
